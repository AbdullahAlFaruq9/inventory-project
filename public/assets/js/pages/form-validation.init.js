!(function (t) {
    "use strict";
    var e = function () {
        (this.$commentForm = t("#commentForm")), (this.$signupForm = t("#signupForm"));
    };
           ...
           // },
            ...
            this.$signupForm.validate({
                rules: {
                    ...
                    agree: "required",
                    name: "required",
                    phone: { required: "[0-9]+", minlength: 11, maxlength: 14 },
                },
                messages: {
                    ...
                    phone: { required: "Please enter a valid phone number", minlength: "Your phone number must consist of at least 11 digit",  maxlength: "Your Phone Number is Invalid" },
                },
            }),
            t("#username").focus(function () {
                var e = t("#firstname").val(),
                    a = t("#lastname").val();
                e && a && !this.value && (this.value = e + "." + a);
            });
        var e = t("#newsletter"),
            a = e.is(":checked"),
            r = t("#newsletter_topics")[a ? "removeClass" : "addClass"]("gray"),
            s = r.find("input").attr("disabled", !a);
        e.click(function () {
            r[this.checked ? "removeClass" : "addClass"]("gray"), s.attr("disabled", !this.checked);
        });
    }),
        (t.FormValidator = new e()),
        (t.FormValidator.Constructor = e);
})(window.jQuery),
    (function (e) {
        "use strict";
